...
import hw5.*;
import hw6.MarvelPaths.EdgeComparator;
...
public class HW5TestDriver {
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        // alphabetize
        Set<Edge<String, String>> tset = 
        		new TreeSet<Edge<String, String>>(new EdgeComparator<String>());
        for(Edge<String, String> e : graph.getEdges(parentName)) {
        	tset.add(e);
        }
        
        for(Edge<String, String> e : tset) {
        	str = str + " " + e.getDestination() + "(" + e.getLabel() + ")";
        }
        output.println(str);
    }
